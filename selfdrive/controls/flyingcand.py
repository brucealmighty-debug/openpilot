...
from selfdrive.config import FLYINGCAN_TO_CAMERA
...
def match_vision_to_cluster(v_ego, lead, clusters):
  ...
  offset_vision_dist = lead.dist - FLYINGCAN_TO_CAMERA
...
# fuses flyingcan data for route planning
...
def main(sm=None, pm=None, flying_can_sock=None):
  flyingcand_thread(sm, pm, flying_can_sock)
