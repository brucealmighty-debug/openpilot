...
from selfdrive.car.interfaces import FlyingCANInterfaceBase

def _create_flying_can_parser(car_fingerprint):
...
class FlyingCANInterface(FlyingCANInterfaceBase):
  def __init__(self, CP):
    ...
    logging.info("FlyingCANInterface __init__")
    ...
    logging.info("Exiting FlyingCANInterface __init__")

  def update(self, can_strings):
    logging.info("FlyingCANInterface update")
    ...
    logging.info("Exiting FlyingCANInterface update")

    return rr

  def _update(self, updated_messages):
    logging.info("FlyingCANInterface _update")
    ...
    logging.info("Exiting FlyingCANInterface _update")
